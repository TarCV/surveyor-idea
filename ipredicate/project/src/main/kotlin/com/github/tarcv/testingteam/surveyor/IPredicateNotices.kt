...
object IPredicateNotices {
    ...
    val gnuStepLibNotice = Notice.loadNoticeFromResource(
    "Test programs of GNUstep - GNU LGPL License",
        "incorporates parts of test programs of GNUStep which are covered by" +
                " the following license:",
    "gnustepbase/COPYING.LIB"
    )
